package com.br.exercicio.exercicio01.service;
...
public class VeiculoServiceTest {
    ...
    public void updateVeiculo_returnUpdatedVeiculo_whenVeiculoValido() {
        ...
        //Nestle exemplo, quando  o método FindById For chamado, o comportamento simulado
        //retorna os dados de um veiculo válido que preparamos para o dublê (simulação)
        BDDMockito.when(repo.findById(ArgumentMatchers.any(Long.class)))
                .thenReturn(Optional.of(GenerateVeiculo.veiculoValido()));
